...
export default function PlanPage() {
  ...
  return <main className="app-shell">
    ...
    <section className="summary-grid" aria-label="Plan overview">
      ...
      <div className="card stat"><span><i aria-hidden="true">⌖</i> Drive limit</span><strong>{plan.max_drive_minutes ? `${plan.max_drive_minutes} min` : "No limit"}</strong></div>
