...
export default function PlanPage() {
  ...
  return <main className="app-shell"><AdventureBackground />
    ...
    <section className="summary-grid" aria-label="Plan overview">
      ...
      <DashboardTile label="Trip notes" icon="✎" value={plan.travel_notes ? <span className="trip-notes-preview">{plan.travel_notes}</span> : "Add notes"} onClick={() => setDashboardEditor("notes")} />
